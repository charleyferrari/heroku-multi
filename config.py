...
os.environ['PLOTLY_USERNAME'] = 'olusola.ogun'
...
os.environ['PLOTLY_API_KEY'] = '1lQbyF2OkmfwxAoGPNix'

# Fill in with your Plotly On-Premise domain
os.environ['PLOTLY_DOMAIN'] = 'http://plotly.exelonds.com'
...
PLOTLY_DASH_DOMAIN='http://plotly-dash.exelonds.com'
